...
|---|---|---|
| Balance Value | currency | MAX(Value) for a selected point-in-time context |
| Cash to Assets | percentage | Cash divided by Assets |
| Latest Cash to Assets | percentage | Latest comparable balance ratio |
| Latest Cash to Assets PY | percentage | Prior fiscal-period comparison |
| Latest Cash to Assets Variance pp | percentage points | Current minus prior-year ratio |
