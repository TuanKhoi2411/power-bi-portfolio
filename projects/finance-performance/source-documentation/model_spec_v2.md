...
- Deduplicate by DisplayMetric, MetricClass, EndDate, and Frame after sorting latest FiledDate first.
- Balance Value uses MAX for point-in-time facts; flow facts continue to use SUM in compatible period context.
- Overview sparklines use period-sensitive quarterly/margin measures.
- Cash to Assets is the fifth balance KPI; filing traceability remains unchanged.
