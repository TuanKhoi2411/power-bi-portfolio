...
|---|---|---|
| Segment Conversion Rate (500+ Contacts) | percentage | Conversion Rate returned only for bases of at least 500 contacts |
| Segment Conversions per 1K (500+ Contacts) | decimal | Per-1K rate with the same base guardrail |
| Sample Size Status | text | Three-level base-size disclosure |
| Duration Leakage Warning | text | Post-contact targeting warning |
| Contact Share | percentage | Selected contacts divided by all contacts |
