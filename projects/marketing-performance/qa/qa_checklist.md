...
- [ ] Expected pages are present: Bank Marketing, Audience Segmentation, Campaign Effectiveness.
...
- [ ] `Portuguese_Bank_Marketing_Performance_Dashboard.pbix` is the latest reviewed build.
